# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-07-02 14:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mass', models.DecimalField(blank=True, decimal_places=5, max_digits=12, null=True)),
                ('mass_unit', models.CharField(blank=True, max_length=40, null=True, verbose_name='Units for Mass')),
                ('frequency', models.DecimalField(blank=True, decimal_places=5, max_digits=12, null=True)),
                ('frequency_unit', models.CharField(blank=True, max_length=40, null=True, verbose_name='Units for Frequency')),
                ('duration', models.DecimalField(blank=True, decimal_places=5, max_digits=12, null=True)),
                ('duration_unit', models.CharField(blank=True, max_length=40, null=True, verbose_name='Units for Duration')),
                ('prevalence', models.CharField(max_length=200, verbose_name='Prevalence')),

...
class ProductIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    short_description = indexes.EdgeNgramField(
        model_attr="short_description", null=True
    )

    brand_name = indexes.CharField(model_attr="brand_name", faceted=True, null=True)

    pucs = indexes.MultiValueField(stored=True, faceted=True, null=True)

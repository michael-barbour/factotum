...
from dashboard.models import DataDocument, DataGroup, DataSource, SourceType
...
class DashboardIndexTest(TestCase):
    ...
    def setUp(self):
        ...
        st = SourceType.objects.create(title="My Source")
        ds = DataSource.objects.create(title="my DS", type=st)
        ...
        dd = DataDocument.objects.create(filename="some.pdf", title="My Document", data_group=dg, source_type=st)

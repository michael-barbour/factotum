        ...
        body={
            "aggs": {
                "data_documents": {
                    ...
                    "aggs": {
                        "top_data_document": {
                            "top_hits": {
                                "_source": ["data_document_id", "data_document_title"],
                                "size": 1,
                            }
                        },
                        "score_sum": {"sum": {"script": {"source": "_score"}}},
                        "num_products": {"cardinality": {"field": "product_id"}},
                    },
                },
                "pucs": {
                    "terms": {
            ...
            "query": {
                "dis_max": {
                    ...
                    "boost": 1.0,
                    "queries": [
                        {"term": {"kind": {"value": "FO", "boost": 0.0}}},
                        {"wildcard": {"raw_cas": {"value": q.lower(), "boost": 1.0}}},
                        {
                            "wildcard": {
                                "raw_chem_name": {"value": q.lower(), "boost": 1.0}
                            }
                        },
                        {"wildcard": {"true_cas": {"value": q.lower(), "boost": 1.0}}},
                        {
                            "wildcard": {
                                "true_chemname": {"value": q.lower(), "boost": 1.0}
                            }
                        },
                        {"wildcard": {"dtxsid": {"value": q.lower(), "boost": 1.0}}},
                    ],
                }
            },
            "size": 0,
        ...
        pucs.append(
            {
                "title": " / ".join(
                    [
                        d[k]
                        for k in ["puc_gen_cat", "puc_prod_fam", "puc_prod_type"]
                        if d[k]
                    ]
                ),

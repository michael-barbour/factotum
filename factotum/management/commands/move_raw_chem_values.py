    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            with connection.cursor() as cursor:
                ...
                cursor.execute(
                    "INSERT INTO dashboard_rawchem (`id`, `raw_cas`, `raw_chem_name`) VALUES ('0', 'Undefined', 'Undefined');"
                ),
                ...
                print(
                    RawChem.objects.all()
                    .values("temp_obj_name")
                    .annotate(total=Count("temp_id"))
                    .order_by("temp_obj_name")
                )
                cursor.execute(
